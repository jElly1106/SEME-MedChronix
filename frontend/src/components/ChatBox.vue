  ...
  <div class="chat-container">
    ...
    <div class="input-container">
      ...
      <div class="input-row">
        ...
        <button class="circle-btn mic-btn" :class="{ recording: isListening }" @click="toggleSpeechRecognition">
        ...
        <div class="input-status-area">
          ...
          <textarea v-else v-model="userInput" placeholder="输入问题..." rows="3"></textarea>
        </div>
