...
from esm.manager_test import Manager
...
def main():
    ...
    parser.add_argument('-rules', '--rules', type=str, help="Rules for the model")
    args = parser.parse_args()
    if args.rules:
        args.rules = ast.literal_eval(args.rules)
        print(f"Parsed Rules: {args.rules}")
    ...
    args.PathDomain = os.path.join(path_storage, args.Domain)
    '''
    ...
    manager.predict_multi_step_since_last_event()
